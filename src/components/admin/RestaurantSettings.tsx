  ...
  return (
    <div className="space-y-8">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Social Media */}
        <div className="bg-white p-6 rounded-lg shadow-sm space-y-4">
          <h2 className="text-xl font-medium mb-4">Redes Sociales</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="url"
                name="instagram"
                defaultValue={config.socialMedia?.instagram}
                className="w-full px-3 py-2 border rounded"
            ...
            <div>
              ...
              <input
                type="url"
                name="facebook"
                defaultValue={config.socialMedia?.facebook}
                className="w-full px-3 py-2 border rounded"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="url"
                name="twitter"
                defaultValue={config.socialMedia?.twitter}
                className="w-full px-3 py-2 border rounded"
            ...
            <div>
              ...
              <input
                type="url"
                name="tiktok"
                defaultValue={config.socialMedia?.tiktok}
                className="w-full px-3 py-2 border rounded"
